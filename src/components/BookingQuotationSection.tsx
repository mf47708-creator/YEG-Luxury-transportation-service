...
export const BookingQuotationSection: React.FC<BookingQuotationSectionProps> = ({
  ...
  return (
    <section
      id="booking"
      className="py-20 lg:py-28 bg-black relative border-t border-b border-neutral-800 overflow-hidden"
    >
      {/* Background ambient lighting effects in gold */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-[#D4AF37]/5 blur-[140px] pointer-events-none" />
      <div className="absolute -bottom-10 right-0 w-[400px] h-[400px] bg-[#D4AF37]/5 blur-[100px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Top Eyebrow Tag */}
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-neutral-900 border border-[#D4AF37]/50 shadow-lg shadow-[#D4AF37]/10 backdrop-blur-md">
            <Sparkles className="w-4 h-4 text-[#D4AF37] animate-pulse" />
            <span className="text-xs sm:text-sm font-extrabold uppercase tracking-[0.25em] text-[#F5D77F]">
        ...
        <div className="text-center max-w-4xl mx-auto mb-6">
          <h2 className="font-cinzel text-3xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight leading-tight uppercase drop-shadow-md">
            BOOK YOUR <span className="text-[#D4AF37]">LUXURY RIDE</span> TODAY
          </h2>
        </div>

        {/* Content Paragraph */}
        <div className="text-center max-w-3xl mx-auto mb-8">
          <p className="text-neutral-200 text-base sm:text-xl font-medium leading-relaxed">
        ...
        <div className="flex items-center justify-center mb-12">
          <div className="px-6 py-3.5 sm:px-10 sm:py-4 rounded-2xl bg-neutral-900 border-2 border-[#D4AF37]/60 shadow-xl shadow-[#D4AF37]/15 flex items-center justify-center gap-3 sm:gap-6 flex-wrap">
            ...
            <span className="text-[#D4AF37] text-lg sm:text-2xl font-bold">•</span>
            <span className="font-cinzel text-base sm:text-xl md:text-2xl font-extrabold text-white uppercase tracking-widest flex items-center gap-2">
              <MessageSquare className="w-5 h-5 text-[#F5D77F]" />
              <span>TEXT US</span>
            </span>
            <span className="text-[#D4AF37] text-lg sm:text-2xl font-bold">•</span>
            <span className="font-cinzel text-base sm:text-xl md:text-2xl font-extrabold text-white uppercase tracking-widest flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-14">
          {/* 1. CALL US CARD */}
          <div className="bg-neutral-900 border-2 border-[#D4AF37]/40 hover:border-[#D4AF37] rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl transition-all duration-300 group hover:-translate-y-1 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#D4AF37]/10 rounded-full blur-3xl pointer-events-none" />
            
            <div>
              <div className="flex items-center justify-between mb-5">
                <div className="w-16 h-16 rounded-2xl bg-[#D4AF37]/15 border border-[#D4AF37]/40 text-[#D4AF37] flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
                  <Phone className="w-8 h-8" />
                </div>
                <span className="px-3 py-1 rounded-full bg-[#D4AF37]/20 text-[#F5D77F] text-[11px] font-extrabold uppercase tracking-wider border border-[#D4AF37]/40">
                  24/7 Priority Line
                </span>
              </div>

              <span className="text-xs font-extrabold uppercase tracking-widest text-neutral-400 block mb-1">
                📞 Direct Phone Call
              </span>
              <h3 className="font-cinzel text-2xl sm:text-3xl font-extrabold text-white mb-2 tracking-wide">
                PHONE
              </h3>
              <p className="text-xs sm:text-sm text-neutral-300 mb-6 leading-normal">
                Call our direct dispatch desk for immediate booking, airport transfers, or instant custom rate confirmations.
              </p>

              <div className="p-4 rounded-xl bg-black border border-neutral-700 mb-6 flex items-center justify-between">
                <div>
                  ...
                  <a
                    href={`tel:${phoneRaw}`}
                    className="font-cinzel text-lg sm:text-xl font-extrabold text-white hover:text-[#F5D77F] tracking-wider block mt-0.5"
                  >
                    {phoneNumber}
                  </a>
                </div>
                ...
                >
                  {copiedType === 'phone' ? <Check className="w-4 h-4 text-[#D4AF37]" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
            </div>
            ...
            <a
              ...
              className="w-full py-4 sm:py-4.5 rounded-xl bg-gradient-to-r from-[#F5D77F] via-[#D4AF37] to-[#AA771C] hover:from-[#FFF8D6] hover:to-[#D4AF37] text-black font-extrabold text-sm sm:text-base uppercase tracking-wider shadow-lg shadow-[#D4AF37]/25 flex items-center justify-center gap-3 transition-all duration-200 cursor-pointer transform group-hover:scale-[1.02] border border-[#FFF8D6]/60"
            >
          ...
          {/* 2. TEXT US (SMS) CARD */}
          <div className="bg-neutral-900 border-2 border-white/40 hover:border-white rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl transition-all duration-300 group hover:-translate-y-1 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-3xl pointer-events-none" />

            <div>
              <div className="flex items-center justify-between mb-5">
                <div className="w-16 h-16 rounded-2xl bg-white/10 border border-white/30 text-white flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
                  <MessageSquare className="w-8 h-8" />
                </div>
                <span className="px-3 py-1 rounded-full bg-white/15 text-white text-[11px] font-extrabold uppercase tracking-wider border border-white/30">
                  Instant SMS
                </span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-black border border-neutral-700 mb-6 flex items-center justify-between">
                ...
                >
                  {copiedType === 'sms' ? <Check className="w-4 h-4 text-[#D4AF37]" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
            </div>
            ...
            <a
              ...
              className="w-full py-4 sm:py-4.5 rounded-xl bg-white hover:bg-neutral-200 text-black font-extrabold text-sm sm:text-base uppercase tracking-wider shadow-lg shadow-white/10 flex items-center justify-center gap-3 transition-all duration-200 cursor-pointer transform group-hover:scale-[1.02]"
            >
              ...
              <div className="p-4 rounded-xl bg-black border border-neutral-700 mb-6 flex items-center justify-between">
                <div className="overflow-hidden">
                  ...
                  <a
                    ...
                    className="text-sm sm:text-base font-bold text-white hover:text-[#F5D77F] truncate block mt-0.5"
                  >
                    {emailAddress}
                  </a>
                </div>
                <button
                  ...
                  className="p-2 rounded-lg bg-neutral-800 hover:bg-neutral-700 text-white transition-colors cursor-pointer flex-shrink-0 ml-2"
                  title="Copy Email Address"
                >
                  {copiedType === 'email' ? <Check className="w-4 h-4 text-[#D4AF37]" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto rounded-3xl bg-neutral-900 border border-[#D4AF37]/40 p-6 sm:p-10 shadow-2xl relative">
          <div className="text-center max-w-xl mx-auto mb-8">
            <span className="text-xs uppercase font-extrabold tracking-widest text-[#D4AF37] block mb-1">
          ...
          <form onSubmit={handleSendQuickInquiry} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-black border border-neutral-700 focus:border-[#D4AF37] rounded-xl text-white text-sm focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-black border border-neutral-700 focus:border-[#D4AF37] rounded-xl text-white text-sm focus:outline-none"
                  />
                </div>
              </div>
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-gradient-to-r from-[#F5D77F] via-[#D4AF37] to-[#AA771C] hover:from-[#FFF8D6] hover:to-[#D4AF37] text-black font-extrabold text-sm sm:text-base uppercase tracking-wider shadow-xl shadow-[#D4AF37]/25 flex items-center justify-center gap-2 cursor-pointer transition-all duration-200 hover:scale-[1.01] border border-[#FFF8D6]/60"
              >
          ...
          <div className="mt-8 pt-6 border-t border-neutral-800 grid grid-cols-2 sm:grid-cols-4 gap-3 text-center text-xs text-neutral-300">
            <div className="flex flex-col items-center gap-1 p-2 rounded-lg bg-black border border-neutral-800">
              <Clock className="w-4 h-4 text-[#D4AF37]" />
              <span className="font-bold text-white">24/7 Dispatch</span>
              <span className="text-[10px] text-neutral-400">Immediate Response</span>
            </div>
            <div className="flex flex-col items-center gap-1 p-2 rounded-lg bg-black border border-neutral-800">
              <ShieldCheck className="w-4 h-4 text-white" />
              <span className="font-bold text-white">Licensed & Insured</span>
              <span className="text-[10px] text-neutral-400">City & Airport Permit</span>
            </div>
            <div className="flex flex-col items-center gap-1 p-2 rounded-lg bg-black border border-neutral-800">
              <Plane className="w-4 h-4 text-[#D4AF37]" />
              <span className="font-bold text-white">YEG Radar Sync</span>
              <span className="text-[10px] text-neutral-400">No Flight Delay Fees</span>
            </div>
            <div className="flex flex-col items-center gap-1 p-2 rounded-lg bg-black border border-neutral-800">
              <Star className="w-4 h-4 text-[#D4AF37] fill-[#D4AF37]" />
              <span className="font-bold text-white">5.0 Star Rating</span>
              <span className="text-[10px] text-neutral-400">Top Alberta Chauffeur</span>
            </div>
          </div>
        </div>
      </div>
