...
export const BookingQuotationSection: React.FC<BookingQuotationSectionProps> = ({
  ...
  return (
    <section
      id="booking"
      className="py-20 lg:py-28 bg-[#080808] relative border-t border-b border-[#C9A45C]/20 overflow-hidden"
    >
      {/* Background ambient lighting effects in Warm Gold */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-[#C9A45C]/10 blur-[140px] pointer-events-none" />
      <div className="absolute -bottom-10 right-0 w-[400px] h-[400px] bg-[#E2C27A]/05 blur-[100px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Top Eyebrow Tag */}
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-[#151515] border border-[#C9A45C]/40 shadow-lg shadow-black/40 backdrop-blur-md">
            <Sparkles className="w-4 h-4 text-[#E2C27A] animate-pulse" />
            <span className="text-xs sm:text-sm font-extrabold uppercase tracking-[0.25em] text-[#F5F3EE]">
        ...
        <div className="text-center max-w-4xl mx-auto mb-6">
          <h2 className="font-cinzel text-3xl sm:text-5xl md:text-6xl font-extrabold text-[#F5F3EE] tracking-tight leading-tight uppercase drop-shadow-md">
            BOOK YOUR <span className="text-[#C9A45C]">LUXURY RIDE</span> TODAY
          </h2>
        </div>

        {/* Content Paragraph */}
        <div className="text-center max-w-3xl mx-auto mb-8">
          <p className="text-[#A7A7A7] text-base sm:text-xl font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-14">
          ...
          <div className="bg-[#151515] border-2 border-white/10 hover:border-[#C8102E] rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl transition-all duration-300 group hover:-translate-y-1 relative overflow-hidden">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#A7A7A7] mb-6 leading-normal">
                Call our direct dispatch desk for immediate booking, airport transfers, or instant custom rate confirmations.
              </p>

              <div className="p-4 rounded-xl bg-[#080808] border border-white/10 mb-6 flex items-center justify-between">
                <div>
                  <span className="text-[10px] text-[#A7A7A7] uppercase tracking-wider block font-bold">
                    Direct Dispatch Number
                  </span>
                  <a
                    href={`tel:${phoneRaw}`}
                    className="font-cinzel text-lg sm:text-xl font-extrabold text-[#F5F3EE] hover:text-[#E2C27A] tracking-wider block mt-0.5"
                  >
                    {phoneNumber}
                  </a>
                </div>
                <button
                  ...
                  className="p-2 rounded-lg bg-[#151515] hover:bg-[#202020] text-[#F5F3EE] transition-colors cursor-pointer"
                  title="Copy Phone Number"
                >
                  {copiedType === 'phone' ? <Check className="w-4 h-4 text-[#C9A45C]" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
            </div>
          ...
          <div className="bg-[#151515] border-2 border-white/10 hover:border-[#C9A45C] rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl transition-all duration-300 group hover:-translate-y-1 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#E2C27A]/10 rounded-full blur-3xl pointer-events-none" />

            <div>
              <div className="flex items-center justify-between mb-5">
                <div className="w-16 h-16 rounded-2xl bg-[#080808] border border-[#C9A45C]/40 text-[#E2C27A] flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
                  <MessageSquare className="w-8 h-8" />
                </div>
                <span className="px-3 py-1 rounded-full bg-white/10 text-[#F5F3EE] text-[11px] font-extrabold uppercase tracking-wider border border-white/20">
                  Instant SMS
                </span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#080808] border border-white/10 mb-6 flex items-center justify-between">
                ...
                >
                  {copiedType === 'sms' ? <Check className="w-4 h-4 text-[#C9A45C]" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
            </div>
            ...
            <a
              ...
              className="w-full py-4 sm:py-4.5 rounded-xl bg-[#F5F3EE] hover:bg-white text-[#080808] font-black text-sm sm:text-base uppercase tracking-wider shadow-lg shadow-white/20 flex items-center justify-center gap-3 transition-all duration-200 cursor-pointer transform group-hover:scale-[1.02]"
            >
              <MessageSquare className="w-5 h-5 fill-current text-[#080808]" />
              <span>TEXT US</span>
            </a>
          </div>
          ...
          <div className="bg-[#151515] border-2 border-white/10 hover:border-[#C9A45C] rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl transition-all duration-300 group hover:-translate-y-1 relative overflow-hidden">
              ...
              <div className="p-4 rounded-xl bg-[#080808] border border-white/10 mb-6 flex items-center justify-between">
                <div className="overflow-hidden">
                  ...
                  <a
                    ...
                    className="text-sm sm:text-base font-bold text-[#F5F3EE] hover:text-[#E2C27A] truncate block mt-0.5"
                  >
                    {emailAddress}
                  </a>
                </div>
                <button
                  ...
                  className="p-2 rounded-lg bg-[#151515] hover:bg-[#202020] text-[#F5F3EE] transition-colors cursor-pointer flex-shrink-0 ml-2"
                  title="Copy Email Address"
                >
                  {copiedType === 'email' ? <Check className="w-4 h-4 text-[#C9A45C]" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
            </div>
            ...
            >
              <Mail className="w-5 h-5 fill-current text-[#080808]" />
              <span>EMAIL US</span>
            </a>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto rounded-3xl bg-[#151515] border-2 border-white/10 hover:border-[#C9A45C]/40 p-6 sm:p-10 shadow-2xl relative">
          <div className="text-center max-w-xl mx-auto mb-8">
            <span className="text-xs uppercase font-black tracking-widest text-[#C9A45C] block mb-1">
              Prefer to send details now?
            </span>
            <h3 className="font-cinzel text-2xl sm:text-3xl font-extrabold text-[#F5F3EE]">
          ...
          <form onSubmit={handleSendQuickInquiry} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#080808] border border-white/15 focus:border-[#C9A45C] rounded-xl text-[#F5F3EE] text-sm focus:outline-none"
                />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  <MapPin className="w-4 h-4 text-[#C9A45C] absolute left-3.5 top-1/2 -translate-y-1/2" />
                  <input
                    type="text"
                    required
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-[#080808] border border-white/15 focus:border-[#C9A45C] rounded-xl text-[#F5F3EE] text-sm focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <MapPin className="w-4 h-4 text-[#E2C27A] absolute left-3.5 top-1/2 -translate-y-1/2" />
                  <input
                    type="text"
                    required
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-gradient-to-r from-[#E2C27A] via-[#C9A45C] to-[#A7843B] hover:from-[#FFF1C5] hover:to-[#C9A45C] text-[#080808] font-black text-sm sm:text-base uppercase tracking-wider shadow-xl shadow-[#C9A45C]/30 flex items-center justify-center gap-2 cursor-pointer transition-all duration-200 hover:scale-[1.01] border border-[#FFF1C5]/40"
              >
          ...
          <div className="mt-8 pt-6 border-t border-white/10 grid grid-cols-2 sm:grid-cols-4 gap-3 text-center text-xs text-[#A7A7A7]">
            <div className="flex flex-col items-center gap-1 p-2.5 rounded-lg bg-[#080808] border border-white/10">
              <Clock className="w-4 h-4 text-[#C9A45C]" />
              <span className="font-bold text-[#F5F3EE]">24/7 Dispatch</span>
              <span className="text-[10px] text-[#A7A7A7]">Immediate Response</span>
            </div>
            <div className="flex flex-col items-center gap-1 p-2.5 rounded-lg bg-[#080808] border border-white/10">
              <ShieldCheck className="w-4 h-4 text-[#E2C27A]" />
              <span className="font-bold text-[#F5F3EE]">Licensed & Insured</span>
              <span className="text-[10px] text-[#A7A7A7]">City & Airport Permit</span>
            </div>
            <div className="flex flex-col items-center gap-1 p-2.5 rounded-lg bg-[#080808] border border-white/10">
              <Plane className="w-4 h-4 text-[#C9A45C]" />
              <span className="font-bold text-[#F5F3EE]">YEG Radar Sync</span>
              <span className="text-[10px] text-[#A7A7A7]">No Flight Delay Fees</span>
            </div>
            <div className="flex flex-col items-center gap-1 p-2.5 rounded-lg bg-[#080808] border border-white/10">
              <Star className="w-4 h-4 text-[#E2C27A] fill-[#E2C27A]" />
              <span className="font-bold text-[#F5F3EE]">5.0 Star Rating</span>
              <span className="text-[10px] text-[#A7A7A7]">Top Alberta Chauffeur</span>
            </div>
          </div>
        </div>
      </div>
